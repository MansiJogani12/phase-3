<div align="center">
  <img src="https://raw.githubusercontent.com/herin7/gitforme/main/gitforme/logo.png" alt="GitVision Logo" width="150"/>
  <h1>GitVision</h1>
...
**GitVision** is an intelligent code exploration platform that solves this problem. Just paste a repository URL, and GitVision generates a comprehensive, interactive dashboard that demystifies the codebase, helping you make your first contribution faster than ever.
...
GitVision uses a microservice architecture to separate concerns and ensure scalability.
...
[GitVision Explainer Video](https://youtu.be/5_eIceKWo7o)

## 🚀 Get It Running Locally

Want to run GitVision on your own machine? Here’s how.
...
4.  **Setup the Frontend**
    ...
    npm run dev
    ```
Your local GitVision instance should now be running at `http://localhost:5173`!
