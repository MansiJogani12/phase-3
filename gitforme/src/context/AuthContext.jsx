    ...
    const verifyWithTokenFallback = async () => {
        ...
        try {
            ...
            const { data } = await axios.post(
                `${apiServerUrl}/api/auth/verifyUser${tokenQuery}`,
                {},
            ...
            console.log('Authentication verification returned an invalid session or token.');
        } catch (sessionError) {
            console.log('Authentication verification failed:', sessionError.message);
        }
